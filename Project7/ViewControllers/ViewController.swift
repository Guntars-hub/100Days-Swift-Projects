...
//  Project7
//
//  Created by guntars.grants on 29/04/2021.
//
...
class ViewController: UITableViewController {
    ...
    @objc func showCredits() {
        let ac = UIAlertController(title: "Where's this API from?", message: "This API comes from whitehouse.", preferredStyle: .alert)
